"""
Prepare a clean drug-response table for LCO splitting.
Purpose
-------
- Takes the raw drug-response data, keeps only the columns needed.
- Checks the important IDs, removes rows where the response is missing.
- Saves a clean table ready for the LCO splitter.
...
Raw_response_file = (
    f"{Data_root}/results/cleaned_results/GDSC2_cleaned.csv"
)

Clean_response_file = (
    f"{Data_root}/data/processed/GDSC2_response_cleaned.csv"
)
...
# ============================================================
# Section 3: DEFINE COLUMNS NEEDED 
# ============================================================
...
# ============================================================
# Section 4: LOAD AND SELECT THE DATA 
# ============================================================
...
# ============================================================
# Section 5: CHECK FOR MISSING IDs
# ============================================================
...
def report_missing_ids(df: pd.DataFrame) -> None:
    ...
    for column in id_columns:
        ...
        print(f" {column}: {n_missing_values} missing values")
...
# ============================================================
# Section 6: REMOVE ROWA WITH MISSING RESPONSE VALUES 
# ============================================================
def drop_missing_response(df: pd.DataFrame) -> pd.DataFrame:
    ...
    n_rows_removed = (n_before_dropped - n_after_dropped)
...
# ============================================================
# Section 7: SUMMARISE THE CLEANED DATA
# ============================================================
...
# ============================================================
# Section 8: SET UP HOW THE SCRIPT WIL BE RUN 
# ============================================================
def main() -> None:
    """
    ...
    # ============================================================
    # Section 9: LOCATE INPUT AND OUTPUT FILES 
    # ========================================================
    input_path = Path(args.input)
    output_path = Path(args.output)

    # ============================================================
    # Section 10: RUN THE DATA-CLEANING STEPS 
    # ========================================================
    print(
